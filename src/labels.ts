...
export const t = {
  ...
  detailPhotos: () => msg('Photos', { id: 'detail_photos' }),
  detailLoading: () => msg('Loading…', { id: 'detail_loading' }),
  detailAccess: () => msg('Access', { id: 'detail_access' }),
  detailBeds: () => msg('Sleeping spots', { id: 'detail_beds' }),
  infoBlankets: () => msg('Blankets', { id: 'info_blankets' }),
  infoLatrines: () => msg('Latrines', { id: 'info_latrines' }),

  legendTitle: () => msg('Legend', { id: 'legend_title' }),
  legendTypes: () => msg('Types', { id: 'legend_types' }),
  legendSymbols: () => msg('Symbols', { id: 'legend_symbols' }),
  legendFireplace: () => msg('Fireplace', { id: 'legend_fireplace' }),
  legendBeds: () => msg('Number of beds', { id: 'legend_beds' }),
  legendMissingWall: () => msg('Open shelter (3 walls)', { id: 'legend_missing_wall' }),
  legendWater: () => msg('Water nearby', { id: 'legend_water' }),
  catRefuge: () => msg('Staffed refuge', { id: 'cat_refuge' }),
  catCabane: () => msg('Unstaffed cabin', { id: 'cat_cabane' }),
  catGite: () => msg('Lodge', { id: 'cat_gite' }),
  catEau: () => msg('Water point', { id: 'cat_eau' }),
